...
def main():
    ...
    while speed and distance != 0:
        ...
        motor_turns = distance * 90
        left_motor.run_to_rel_pos(position_sp=motor_turns, speed_sp=speed, stop_action="brake")
        right_motor.run_to_rel_pos(position_sp=motor_turns, speed_sp=speed, stop_action="brake")
