...
Authors: David Fisher and Chip Daniel.
...
def main():
    ...
    while distance_in != 0:
        ...
        inches_target = int(input("Enter a distant to travel: "))
        degrees_per_inch = 90
        motor_turns_needed_in_degrees = inches_target * degrees_per_inch

        left_motor.run_to_rel_pos(position_sp= motor_turns_needed_in_degrees, speed_sp= speed_sp, stop_action='brake')
        right_motor.run_to_rel_pos(position_sp=motor_turns_needed_in_degrees, speed_sp=speed_sp, stop_action='brake')
